...
/**
 * This class implements all the methods needed for an Infra structure provider.
 */
public class InfraStructureProvider {
    ...
    /**
     * The constructor of the class, It fills the name and base charge instances with its given values.
     * @param providerName
     * @param baseCharge
     */
    InfraStructureProvider(String providerName, double baseCharge){
